...
from src.application.repositories.i_nosql_template_repository import INOSQLTemplateRepository
...
class NoSQLTemplateService:
	...
	def __init__(self, repository: Type[INOSQLTemplateRepository]):
