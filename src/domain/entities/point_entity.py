...
class PointEntity(BaseModel):
	"""
	Base entity for Vector database point. This entity will be extended with the appropriate payload in order to made up
	an entity that will be stored on the Vector database.
	"""
